  ...
  <div class="flex flex-col gap-4 max-w-screen-2xl mx-auto p-4">
    <section class="main-section">
      ...
      <div class="card flex gap-5">
        <FloatLabel>
          <InputText id="menu name" v-model="value" class="p-3" />
        ...
        />
        <Button label="Save" icon="fa fa-check" iconPos="left" @click="" />
      </div>
    </section>
    ...
    <section class="main-section">
      ...
      <div class="card flex gap-5">
        <FloatLabel>
          <InputText id="category-name" v-model="newCategory" class="p-3" />
